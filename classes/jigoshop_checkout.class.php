...
class jigoshop_checkout extends Jigoshop_Singleton {
	...
	public static function get_billing_fields()
	{
		$billing_fields = array(
			array(
				...
				'label' => __('Ime', 'jigoshop'),
				'placeholder' => __('Ime', 'jigoshop'),
				'required' => true,
				'class' => array('form-row-first')
			),
			array(
				'name' => 'billing_last_name',
				'label' => __('Prezime', 'jigoshop'),
				'placeholder' => __('Prezime', 'jigoshop'),
				'required' => true,
			...
			array(
				'name' => 'billing_phone',
				'validate' => 'phone',
				'label' => __('Telefon', 'jigoshop'),
				'placeholder' => __('Telefon', 'jigoshop'),
				'required' => true,
				'class' => array('form-row-last'),
			),
			array(
				'name' => 'billing_address_1',
				'label' => __('Adresa', 'jigoshop'),
				'placeholder' => __('Addresa', 'jigoshop'),
				'required' => true,
				'class' => array('form-row-first')
			),
	...
	public function checkout_form_billing() {
		if ( jigoshop_cart::ship_to_billing_address_only() ) {
			...
			echo '<h3>'.__('Podaci o klijentu', 'jigoshop').'</h3>';
		}
	...
	function checkout_form_shipping() {
		...
		$this->field(array(
			...
			'class' => array('notes'),
			'name' => 'order_comments',
			'label' => __('Dodatne informacije', 'jigoshop'),
			'placeholder' => __('Dodatne informacije o porudzbini.', 'jigoshop')
		));
	}
